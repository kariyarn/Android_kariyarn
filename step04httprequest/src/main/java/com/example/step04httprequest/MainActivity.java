...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestBtn.setOnClickListener(view -> {
            ...
            //http요청을 하고
            new RequestTask().execute("https://www.acornacademy.co.kr/index.jsp");//이 메소드는 호출 즉시 리턴된다.
            //정상적으로 응답이되면 응답된 문자열을 EditText 출력하기
        });
    }
    //비동기 Task 객체를 생성할 클래스
    class RequestTask extends AsyncTask<String, Void, String>{
        //백그라운드(새로운 스레드의 run()메소드)에서 작업할 내용을 이 메소드에서 작업하면된다.
        @Override
